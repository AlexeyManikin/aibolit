...
echo "/usr/bin/php -d short_open_tag=off ai-bolit.php --skip-cache --addprefix=$CHECK_DIR_ALL --noprefix=/home/beget/site -p /home/beget/site -m 3096M --mode=$MODE --report=/home/report/$REPORT" >> /home/beget/aibolit/run.sh
